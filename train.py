...
def fit_one_epoch(model_rpn, model_all, epoch, epoch_size, epoch_size_val, gen, genval, Epoch, callback):
    ...
    # model_all.save('logs/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.h5' % (
    #     (epoch + 1), total_loss / (epoch_size + 1), val_toal_loss / (epoch_size_val + 1)))
    # model_all.save('obs://fjj-grad-frcnn/Faster_Rcnn/logs/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.h5' % (
    #     (epoch + 1), total_loss / (epoch_size + 1), val_toal_loss / (epoch_size_val + 1)))
    return
...
if __name__ == "__main__":
    ...
    # base_net_weights = "obs://fjj-grad-frcnn/Faster_Rcnn/model_data/voc_weights.h5"
    ...
    # annotation_path = 'F:/Faster_Rcnn/2007_train.txt'
    # annotation_path = 'F:/Faster_Rcnn/2007_train.txt'
    annotation_path = '2007_train_obs.txt'
